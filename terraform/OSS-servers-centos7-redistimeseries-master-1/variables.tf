...
variable "setup_name" {
  ...
  default     = "perf-cto-OSS-servers-centos7-redistimeseries-master-1"
}

variable "re_cluster_name" {
 description = "re_cluster_name"
  default     = "oss-cluster-1vm-centos7-redistimeseries-master-1"
}
...
variable "redistimeseries_version" {
 description = "redistimeseries_version"
  default     = "96cc3386633019646219b852a2945ca3406f0f05"
}
...
variable "redis_config" {
 description = "redis_config"
  default     = "oss_redis_redistimeseries.conf.j2"
}
...
variable "instance_ami" {
  description = "AMI for aws EC2 CentOS 7 (x86_64) - with Updates HVM"
