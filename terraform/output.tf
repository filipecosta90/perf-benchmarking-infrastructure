...
output "perf_cto_server_c5n_18xlarge_hyperthreading_vector" {
  value = ["${aws_instance.perf_cto_server_c5n_18xlarge_hyperthreading[0].public_ip}:44323"]
}


output "perf_cto_server_c5_18xlarge_hyperthreading_vector" {
  value = ["${aws_instance.perf_cto_server_c5_18xlarge_hyperthreading[0].public_ip}:44323"]
}